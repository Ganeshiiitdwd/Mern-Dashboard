...
import {HomeOutlined,AccountCircleOutlined,ChatBubbleOutline,PeopleAltOutlined,StarOutlineRounded,VillaOutlined} from '@mui/icons-material'
import { Login ,Home,AllProperty,PropertyDetails,CreateProperties,EditProperty,Agents,AgentsProfile,Myprofile} from "pages";
              ...
              <Refine
                ...
                resources={[
                  ...
                  {  //list gives the initial route then show is for show here we again mention our other route "show/:id" it should match with corresponding routes
                    name: "properties",
                    list:"/properties",show:"/properties/show/:id",create:"/properties/create",edit:"/properties/edit/:id",
                   
                    icon:<VillaOutlined/>
                  },
                  {
                    name: "agents",
                    list:"/agents", show:"/agents/show/:id",
                    icon:<PeopleAltOutlined/>
                  },
                  {
                    name: "Reviews",
                    list:"/Reviews",icon:<StarOutlineRounded/>
                  },
                  {
                    name: "Messages",
                    list:"/Messages",icon:<ChatBubbleOutline/>
                  },
                  {
                    name: "My Profile",
